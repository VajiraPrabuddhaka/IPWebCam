        ...
        implements SurfaceHolder.Callback
{
    ...
    private SurfaceView transParent =null;
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        transParent = ((SurfaceView)findViewById(R.id.camera_t));
    ...
    private void tryStartCameraStreamer()
    {
        ...
        {
            mCameraStreamer = new CameraStreamer(mCameraIndex, mUseFlashLight, mPort, mPrevieSizeIndex, mJpegQuality, mPreviewDisplay);
            mCameraStreamer.start();
            System.out.println("mCameraIndex : "+ mPreviewDisplay);
        } // if
    } // tryStartCameraStreamer()
